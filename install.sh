...
URL="https://github.com/$REPOOWNER/$REPONAME/releases/download/${RELEASETAG}/how_${RELEASETAG}_${KERNEL}_${MACHINE}.tar.gz"

echo "Downloading version $RELEASETAG from $URL"
echo

curl -q --fail --location --progress-bar --output "how_${RELEASETAG}_${KERNEL}_${MACHINE}.tar.gz" "$URL"
tar xzf "how_${RELEASETAG}_${KERNEL}_${MACHINE}.tar.gz"
chmod +x $BINNAME
sudo mv $BINNAME $BINDIR/$BINNAME
rm "how_${RELEASETAG}_${KERNEL}_${MACHINE}.tar.gz"
